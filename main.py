"""Simple game for training in Python dev."""
...
def attack(char_name: str, char_class: str) -> str:
    """Calculate and print damage from classes."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate and print classes defence."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Calculate and print classes special abilities."""
    if char_class == 'warrior':
